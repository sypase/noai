...
import Item from '../../models/Item.js'; // Adjust the path as needed
...
router.get('/create-order-imepay', async (req, res) => {
  try {
...
router.get('/callback', async (req, res) => {
  console.log("asdsas213123asdasd");
  try {
...
//     if (response.data.ResponseCode !== '0') {
//       console.log("_____Confirmation__SUCESS____");
...
// Helper function to store transaction details (implement according to your database)
async function storeTransactionDetails(transactionData) {
  // TODO: Implement this function to store the transaction details in your database
  console.log('Storing transaction details:', transactionData);
}

// Helper function to update transaction details (implement according to your database)
async function updateTransactionDetails(transactionData) {
  // TODO: Implement this function to update the transaction details in your database
  console.log('Updating transaction details:', transactionData);
}
...
router.get('/payment-cancelled', (req, res) => {
  res.send('Payment cancelled. You can try again when youre ready.');
});
